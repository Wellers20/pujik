...
import { Calendar, Hash, Settings, Camera, X, Users } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-8 relative">
      ...
      <div className="flex border-b border-zinc-200 mb-6 sticky top-14 bg-[#fafafa]/80 backdrop-blur-md z-10 pt-2">
        <button className="pb-3 px-6 text-[15px] font-bold text-zinc-900 border-b-[3px] border-zinc-900 transition-colors">
          Записи
        </button>
      </div>
            ...
            >
              ...
              <div className="space-y-3">
                <button 
                  ...
                  className="w-full flex justify-center items-center py-3.5 bg-zinc-50 text-zinc-900 border border-zinc-200 font-bold text-[15px] rounded-2xl hover:bg-zinc-100 active:scale-[0.98] transition-all sm:hidden"
                >
